...
###### Version : [`r getNamespaceVersion("BayesAMMI2")`](https://myaseen208.com/BayesAMMI2/); Copyright (C) 2018-2024: License: [GPL-2|GPL-3](https://www.r-project.org/Licenses/)


##### *Muhammad Yaseen^1,2^, Jose Crossa^3,4,5,6^, Sergio Perez-Elizalde^7^, Diego Jarquin^8^, Julian Garcia Abadillo Velasco^8^*
